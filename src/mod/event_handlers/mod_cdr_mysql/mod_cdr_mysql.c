 ...
 *
 * Contributor(s):
 * Christopher Dye <chris.dye@paragon.net>
 *
 * mod_cdr_mysql.c -- MySQL CDR Module
 * derived from:
...
static switch_xml_config_item_t config_settings[] = {
	...
	SWITCH_CONFIG_ITEM_STRING_STRDUP("db-pass", CONFIG_RELOADABLE, &globals.db_pass, "ClueCon", NULL, NULL),
